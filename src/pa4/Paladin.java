 ...
 * Paladin.java - Defines the class that represents the Paladin type of hero in the game of LHM
 */
...
public class Paladin extends Hero {
	...
	public static List<String> listOptions() {
		String file = System.getProperty("user.dir") + "/ConfigFiles/" + "Paladins.txt";
